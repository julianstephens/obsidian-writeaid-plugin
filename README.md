...
| `create-outline`                       | Create Outline                            | Create an outline file for the active draft using the outline template.                                                                                                                                 | Ctrl/Cmd+Alt+O       |
...
| `open-project-meta`                    | Open Project Meta                         | Open the active project's `meta.md` file in the editor for quick access to project settings and metadata.                                                                                               |                      |
...
| `initialize-draft-file`                | Initialize Draft File Metadata            | Generate or complete draft file metadata in the active draft folder. Handles empty folders (creates new file), single files (validates/completes metadata), and multiple files (opens selection modal). |                      |
