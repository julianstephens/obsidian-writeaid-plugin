...
import { ConvertIndexModalProps } from './modalTypes';

export class ConvertIndexModal extends Modal {
  props: ConvertIndexModalProps;

  constructor(app: App, props: ConvertIndexModalProps) {
    super(app);
    this.props = props;
  }
  ...
  const folders = this.props.folders || [];
    ...
    new Setting(contentEl).setName('Create as checklist').addToggle((t) => t.setValue(true).onChange((v) => (asChecklist = v)));
