...
- For single-file projects: `Drafts/{DraftName}/draft.md` with metadata
- For multi-file projects: `Drafts/{DraftName}/` with outline and initial chapter

**Generated Metadata (Single-File Projects):**

WriteAid automatically generates all required frontmatter fields:

```yaml
---
id: "<auto-generated-uuid>"
draft_name: "<your-draft-name>"
project_id: "<parent-project-uuid>"
word_count: 0
last_updated: "2025-01-15T14:30:45.123Z"
---
```

**Field Generation Details:**

- `id`: Unique UUID generated for each draft
- `draft_name`: Your entered draft name
- `project_id`: Automatically extracted from parent project metadata
- `word_count`: Initialized to 0
- `last_updated`: Set to creation time (ISO 8601 UTC format)

**Auto-Maintenance:**

- `word_count` is automatically updated as you edit
- `last_updated` is automatically updated on modifications
- `id` and `project_id` are immutable after creation

**Generated Metadata (Multi-File Projects):**

For multi-file projects, WriteAid creates an initial chapter with:
